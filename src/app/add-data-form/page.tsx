...
export default function Page() {
  const form = useForm({
    defaultValues: {
      ...
      medicalHistory: [
        { condition: "", diagnosedOn: "", status: "Ongoing", notes: "" },
      ],
      surgicalHistory: [
        { surgery: "", date: "", hospital: "", surgeon: "", notes: "" },
      ],
    },
  });
        ...
        <div className="bg-white p-6 md:p-10 rounded-lg shadow-inner space-y-8">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                {form.watch("medicalPrescription")?.map((_, presIndex) => (
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      {form
                        .watch(`medicalPrescription.${presIndex}.medications`)
                        ?.map((_, medIndex) => (
                          <div
                            key={medIndex}
              ...
              <Button
                type="button"
                onClick={() => addDrugAllergy({ name: "", severity: "Low" })}
              >
                + Add Drug Allergy
              </Button>
